export const profile = {
  ...
  focus: 'Frontend Systems · React / TypeScript · NestJS · Enterprise Platforms',
  location: 'Abu Dhabi, UAE',
  email: 'asadullahriaz94@gmail.com',
  ...
  stats: [
    ...
    { label: 'Roles Shipped', value: '8' },
    { label: 'Typical Test Coverage', value: '80%' },
  ],
};
